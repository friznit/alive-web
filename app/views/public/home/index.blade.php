        ...
        <div class="row">
            <div class="col-md-7">
                ...
                <table class="table">
                    ...
                    <tr class="success">
                        <td>1.0.5.1605051</td>
                        <td>Arma 3 Stable 1.58.135742</td>
                        <td><a class="btn btn-primary btn-lg pull-right" href="http://alivemod.com/downloads/@ALiVE_1.0.5.1605051.7z"><i class="fa fa-download"></i> Download</a></td>
