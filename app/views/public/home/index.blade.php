        ...
        <div class="row">
            <div class="col-md-7">
                ...
                <table class="table">
                    ...
                    <tr class="success">
                        <td>1.0.7.1606161</td>
                        <td>Arma 3 Stable 1.60.136406</td>
                        <td><a class="btn btn-primary btn-lg pull-right" href="http://alivemod.com/downloads/ALiVE_1.0.7.1606161.7z"><i class="fa fa-download"></i> Download</a></td>
