<div class="jumbotron dark2-panel" id="INFO">
    <div class="container">
        <div class="row">
            <div class="col-md-4">
        ...
        <div class="row">
            <ul class="list-inline pull-right">
                <li><p>&copy;<?php echo date('Y') ?> ALiVE</p></li>
                <li><a target="_blank" href="https://www.facebook.com/pages/ALiVE-Advanced-Light-Infantry-Virtual-Environment/547638945305077" class="btn btn-dark"><i class="fa fa-facebook"></i> ALiVE on Facebook</a></li>
                <li><a target="_blank" href="https://plus.google.com/u/0/b/102227916567919683098/102227916567919683098/posts" class="btn btn-dark"><i class="fa fa-google-plus"></i> ALiVE on Google Plus</a></li>
                <li><a target="_blank" href="https://www.youtube.com/user/ALIVEARMA3?feature=watch" class="btn btn-dark"><i class="fa fa-youtube-play"></i> ALiVE on YouTube</a></li>
            </ul>
        </div>
    </div>
</div>