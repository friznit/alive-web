<script>
    $(document).ready(function(){
        $('#top_vehicles').dataTable({
					"bJQueryUI": true,
					"sAjaxSource": "http://msostore.iriscouch.com/events/_design/playerPage/_view/players_vehxp?&group_level=3&startkey=[%22{{ $player_id }}%22]&endkey=[%22{{ $player_id }}%22,{}]&callback=?",
					"sAjaxDataProp": "rows",
                    "bPaginate": false,
                    "bFilter": false,
                    "bInfo": false,
					...
					"aoColumnDefs": [
						{ "mDataProp": "key.1",  "aTargets": [ 0 ],
							"mRender" : function (data, type) {
				  				return "<img src={{ URL::to('img/classes/small/300px-Arma3_CfgVehicles_') }}" + data + ".png>";}
						},
