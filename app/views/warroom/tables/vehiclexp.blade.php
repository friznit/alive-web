<script>
    $(document).ready(function(){
        $('#top_vehicles').dataTable({
					"bJQueryUI": true,
					"sAjaxSource": "http://msostore.iriscouch.com/events/_design/events/_view/players_vehxp?&group_level=3&startkey=[%22{{ $player_id }}%22]&endkey=[%22{{ $player_id }}%22,{}]&callback=?",
					"sAjaxDataProp": "rows",
                    "bPaginate": false,
                    "bFilter": false,
                    "bInfo": false,
